...
//	CANTalon _leftRear;
//	CANTalon _rightRear;
	WPI_TalonSRX _spareTalon; /* spare talon, remove if not necessary, Pigeon can be placed on CANbus or plugged into a Talon. */
	PigeonIMU _pidgey;
	...
	public Robot() {
		...
		_rightFront = new WPI_TalonSRX(3);
//		_leftRear = new CANTalon(4);
//		_rightRear = new CANTalon(1);
		_spareTalon = new WPI_TalonSRX(2);
